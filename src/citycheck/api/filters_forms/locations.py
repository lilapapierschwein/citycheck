...
class LocationQueryParams(QueryParams):
    orderBy: Literal[
        "id",
        "location_name",
    ] = "id"
    user_id: LowercaseStr | None = None
    username: LowercaseStr | None = None
    location_id: bool | None = Field(validation_alias="isDisabled", default=None)
    location_name: bool | None = Field(validation_alias="isDeleted", default=None)
...
LocationQueryFilters = Annotated[LocationQueryParams, Query()]
